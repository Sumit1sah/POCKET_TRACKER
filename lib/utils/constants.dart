...
class AppConstants {
  ...
  static List<CategoryModel> defaultCategories = [
    ...
    CategoryModel(
      ...
      colorValue: const Color(0xFF6C5CE7).toARGB32(),
      isDefault: true,
      deductFromBudget: false, // CC bill payment is a liability repayment, not a budget expense
    ),
    CategoryModel(
      id: 'cat_others',
      uid: 'system',
    ...
    CategoryModel(
      ...
      colorValue: const Color(0xFF00B894).toARGB32(),
      isIncome: true,
      isDefault: true,
    ),
    CategoryModel(
      id: 'cat_cc_cashback',
      uid: 'system',
      name: 'CC Cashback / Refund',
      iconCodePoint: Icons.credit_score.codePoint,
      colorValue: const Color(0xFF6C5CE7).toARGB32(),
      isIncome: true,
      isDefault: true,
    ),
